...
filename <- "/Users/mailos/PhD/dummy/Analyses/UKBiobank/data/chr17inv.gds"
...
# bdCreate_hdf5_matrix_file(filename = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8.hdf5", object = genotype, group = "invs", dataset = "geno")

bdCreate_hdf5_matrix( filename = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr17.hdf5", 
...
remsamples <- bdRemovelowdata_hdf5("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr17.hdf5", 
                                   group = "invs", 
                                   dataset = "geno", 
                                   outgroup = "invs", 
...
ressnps <- bdRemoveMAF_hdf5 ("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr17.hdf5", 
                             group = "invs", 
                             dataset = "genofilter", 
                             outgroup = "invs", 
...
bdImputeSNPs_hdf5( "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr17.hdf5", 
                   group = "invs", 
...
res <- bdSVD_hdf5(file = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr17.hdf5", 
                  group = "invs", 
                  dataset = "genofilter_maf", 
                  k = 40, 
                  threads = 8, 
...
#..# h5fsvd = H5Fopen("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8.hdf5")
...
fname <- paste0("plots/chr17_cumvar.png")
...
# R default plot
fname <- paste0("plots/chr17_PCA_1and2_U.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
plot(u[,"PC2"], u[,"PC1"])
dev.off()
...
# ggplot plot
fname <- paste0("plots/chr17_PCA_1and2_ggplot_U.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
# ggplot plot
fname <- paste0("plots/chr17_PCA_1and2_ggplot_V.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
# ggplot plot
fname <- paste0("plots/chr17_PCA_1and2_ggplot_Ui.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
fname <- paste0("plots/chr17_PCA.pdf")
#fname <- paste0("plots/PCA/chr17_PCA.png")
...
# # #
# setwd("/home/isglobal.lan/dpelegri/working/TFM/results") #.. SERVER 06 ..#
# filename <- "/home/isglobal.lan/dpelegri/working/TFM/data/UkbBiobank/chr17inv.gds"
# filehdf <-  "data/chr17.h5"
# #
# # Open gds file
#
