...
dir.create("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/",  recursive = TRUE, showWarnings = FALSE)
dir.create("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/plots",  recursive = TRUE, showWarnings = FALSE)
...
setwd("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/") #.. Yamabuki Server ..# 
filename <- "/Users/mailos/PhD/dummy/Analyses/UKBiobank/data/chr8_region.gds"
...
# bdCreate_hdf5_matrix_file(filename = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", object = genotype, group = "invs", dataset = "geno")

bdCreate_hdf5_matrix( filename = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", 
                      object = genotype, group = "invs", dataset = "geno", overwriteFile = TRUE, overwriteDataset = TRUE)

print(paste0(format(Sys.time(), "%a %b %d %X %Y - "), "End to write data to the hdf5 file...."))
...
remsamples <- bdRemovelowdata_hdf5("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", 
                                   group = "invs", 
                                   dataset = "geno", 
                                   outgroup = "invs", 
...
print(paste0(format(Sys.time(), "%a %b %d %X %Y - "), "End to remove Samples with 5% missing data ... "))
...
ressnps <- bdRemoveMAF_hdf5 ("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", 
                             group = "invs", 
                             dataset = "genofilter", 
                             outgroup = "invs", 
...
print(paste0(format(Sys.time(), "%a %b %d %X %Y - "), "End Removing SNPs with maf 5% ... "))
...
bdImputeSNPs_hdf5( "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", 
                   group = "invs", 
...
print(paste0(format(Sys.time(), "%a %b %d %X %Y - "), "End Imputing missings..... "))
...
res <- bdSVD_hdf5(file = "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5", 
                  group = "invs", 
                  dataset = "genofilter_maf", 
                  k = 10, 
                  q = 2, 
...
hdf5_filename <- "/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5"
h5ls(hdf5_filename)
...
#..# h5fsvd = H5Fopen("/Users/mailos/PhD/dummy/Analyses/UKBiobank/InversionCalling/results/data/chr8_regions.hdf5")
h5fsvd = H5Fopen(hdf5_filename)
...
fname <- paste0("plots/chr8_regions_cumvar.png")
...
# R default plot
fname <- paste0("plots/chr8_regions_PCA_1and2_U.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
plot(u[,"PC2"], u[,"PC1"])
dev.off()
...
# ggplot plot
fname <- paste0("plots/chr8_regions_PCA_1and2_ggplot_U.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
# ggplot plot
fname <- paste0("plots/chr8_regions_PCA_1and2_ggplot_V.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
# ggplot plot
fname <- paste0("plots/chr8_regions_PCA_1and2_ggplot_Ui.png")
png(fname, width = 8, height = 8, units = 'in', res = 600, pointsize = 4)
...
fname <- paste0("plots/chr8_regions_PCA.pdf")
