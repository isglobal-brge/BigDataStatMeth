...
Create_HDF5_matrix_file(filename = "robject.hdf5", 
                        object = A, 
                        group = "INPUT", 
                        dataset = "A")
```
...
Create_HDF5_matrix_file(filename = "delayed.hdf5", 
                        object = A, 
                        group = "INPUT", 
                        dataset = "A")

# And them, we add another matrix B to the same group
Add_HDF5_matrix(object = B, 
...
```{r crossprod}
res <- Crossprod_hdf5(filename = 'robject.hdf5', 
                      group="INPUT", 
                      A="A", 
                      outgroup = "RESULTS")
```
