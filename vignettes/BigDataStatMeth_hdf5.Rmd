...
Dealing with [DelayedArray](https://bioconductor.org/packages/release/bioc/html/DelayedArray.html) requires: `beachmat`, `DelayedArray`. The user can execute this code to install the required packages:
