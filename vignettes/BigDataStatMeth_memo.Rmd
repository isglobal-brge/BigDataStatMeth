...
bench1 <- microbenchmark( 
  Paral128Mem = blockmult(Abig, Bbig, paral = TRUE), # Parallel block size = 128
  Paral256Disk = blockmult(Abig, Bbig, block_size=256, paral=TRUE), # On disk parallel block size = 256
  Paral256Mem = blockmult(Abig, Bbig, block_size=256, paral=TRUE, onmemory=TRUE),
  Paral1024Mem = blockmult(Abig, Bbig, block_size=1024, paral=TRUE, onmemory=TRUE),
  times = 3 )
...
res <- microbenchmark(
  bdcrossp_tr = bdcrossprod(A, transposed=TRUE),
