...
<center> ![hierarchical structure](imgs/hdf5_squema.jpg)</center>
...
More information about working with hdf5 files in r [rhdf5 - HDF5 interface for R](https://bioconductor.org/packages/release/bioc/vignettes/rhdf5/inst/doc/rhdf5.html)
...
<center> ![Flowchart for a two-level hierarchical Block SVD algorithm](imgs/blocksvd.png )</center>
