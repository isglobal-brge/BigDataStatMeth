...
We first simulate a genotype matrix with 0, 1, 2 and 3 and store it in hdf5 file:
```{r snpgenotype}
...
Nowe we impute values where genotype = '3' (missing data), here we :
```{r impute}
bdImputeSNPHDF5("delayed.hdf5", group = "OMICS", dataset = "geno", bycols = TRUE)
