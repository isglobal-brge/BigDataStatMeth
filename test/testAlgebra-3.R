...
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 1, q = 4, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 2, q = 2, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
...
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 2, q = 1, bcenter = FALSE, bscale = FALSE, rankthreshold = 0.0, force  = TRUE, threads = NULL);  resr <- svd(Y)
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 2, q = 2, bcenter = TRUE, bscale = FALSE, rankthreshold = 0.0, force  = TRUE, threads = NULL);  resr <- svd(scale(Y, center = TRUE, scale = FALSE))
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 1, q = 3, bcenter = FALSE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);  resr <- svd(scale(Y, center = FALSE, scale = TRUE))
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 1, q = 1, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 1, q = 4, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", k = 2, q = 2, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, force  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
