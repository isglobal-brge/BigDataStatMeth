...
bdSVD_hdf5( "test_temp.hdf5", group = "data", dataset = "matrix", method = "blocks", k = 1, q = 4, bcenter = TRUE, bscale = TRUE, rankthreshold = 0.0, overwrite  = TRUE, threads = NULL);   resr <- svd(scale(Y, center = TRUE, scale = TRUE))
