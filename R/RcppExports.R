...
bdPCA_hdf5 <- function(filename, group, dataset) {
    .Call(`_BigDataStatMeth_bdPCA_hdf5`, filename, group, dataset)
}
...
blockmult <- function(a, b, block_size = NULL, paral = NULL, threads = NULL, bigmatrix = NULL, outfile = NULL, mixblock_size = NULL) {
    .Call(`_BigDataStatMeth_blockmult`, a, b, block_size, paral, threads, bigmatrix, outfile, mixblock_size)
}
...
Create_HDF5_matrix_file <- function(filename, mat, group = NULL, dataset = NULL) {
    .Call(`_BigDataStatMeth_Create_HDF5_matrix_file`, filename, mat, group, dataset)
}
...
Create_HDF5_matrix <- function(mat, filename, group, dataset) {
    .Call(`_BigDataStatMeth_Create_HDF5_matrix`, mat, filename, group, dataset)
}
